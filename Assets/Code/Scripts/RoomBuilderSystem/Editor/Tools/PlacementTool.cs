namespace RBS.Editor.Tools
{
    ...
    public class PlacementTool : ToolBase
    {
        ...
        private void DrawSelector()
        {
            ...
            }, "RBSRoom Selector", GUILayout.MinWidth(100), GUILayout.MinHeight(100), GUILayout.MaxWidth(400), GUILayout.MaxHeight(600));
            Handles.EndGUI();
        }
        ...
        {
            if (_previewDragger.TryPlacePrefab(out GameObject placedGameobject))
            {
                placedGameobject.transform.SetParent(RBSObjectsUtility.GetRoomsParent());
                placedGameobject.name = CurrentRoomData.RoomPrefab.name;
